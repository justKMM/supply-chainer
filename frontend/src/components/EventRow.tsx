...
export function EventRow({ timestamp, from, to, type, message, status, color }: EventRowProps) {
  return (
    <div className="flex items-start gap-3 px-4 py-3 border-b border-border/50 hover:bg-secondary/30 transition-colors group">
